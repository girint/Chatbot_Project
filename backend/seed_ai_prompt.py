...
from models import BasicAI, User, Notice
...
def seed_basic_ai():
    ...
    with app.app_context():
        ...
        users = {
            'admin1': (1, 'dltkdtn@naver.com', '1234', "관리자"),
        ...
        notices = {
            'notice1': (1, 
                        '[공지] 📢 챗봇 무료 이용 횟수 소진 안내', 
                        """
🔔 챗봇 무료 이용 횟수 소진 안내

안녕하세요.
챗봇 서비스 무료 이용 횟수 소진 기준에 대해 아래와 같이 안내드립니다.

📌 무료 이용 정책 안내
 - 챗봇은 최초 3개의 챗봇까지 무료로 이용 가능합니다.
 - 무료 이용 횟수 소진 후에는 결제 완료 시에만 추가 챗봇 이용이 가능합니다.

📌 무료 이용 횟수 차감 기준
 - 무료 이용 횟수는 **챗봇 대화 시작(새로운 대화 세션 시작 기준)**로 차감됩니다.

📌 무료 이용 횟수 소진 시 안내
 - 무료 이용 횟수(3개 챗봇)를 모두 사용한 경우,
 - 추가 챗봇 이용은 불가능하며 결제 안내 화면이 표시됩니다.

📌 결제 후 이용 안내
 - 결제 완료 후에는 즉시 추가 챗봇 서비스 이용이 가능합니다.
 - 이용 조건 및 범위는 결제 상품에 따라 달라질 수 있습니다.

📌 유의사항
 - 무료 이용 정책은 서비스 운영 정책에 따라 변경될 수 있으며,
   변경 시 사전 공지를 통해 안내드릴 예정입니다.
 - 비정상적인 방법으로 무료 이용을 반복 시도하는 경우,
   서비스 이용이 제한될 수 있습니다.

원활한 서비스 이용을 위해 위 내용을 꼭 확인해 주시기 바랍니다.
감사합니다.
                        """
                        ),
            'notice2': (2,
                        '[공지] 📢 챗봇 답변 이용 시 유의사항', 
                        """
⚠️ 챗봇 답변 이용 시 유의사항 안내

안녕하세요.
챗봇 서비스 이용과 관련하여 아래 유의사항을 안내드립니다.

📌 챗봇 답변의 성격 안내
 - 챗봇이 제공하는 답변은 일반적인 정보 제공을 목적으로 한 참고용 내용입니다.
 - 답변 내용은 사용자의 입력 정보, 상황, 시점에 따라 정확성이나 완전성이 보장되지 않을 수 있습니다.

📌 전문 자문 대체 불가
 - 챗봇 답변은 법률, 의료, 재무, 투자, 상담 등 전문적인 자문을 대체하지 않습니다.
 - 중요한 의사결정이 필요한 경우, 반드시 관련 분야의 전문가와 상담하시기 바랍니다.

📌 답변 오류 및 책임 제한
 - 챗봇 답변에는 오류, 누락, 표현상의 한계가 있을 수 있습니다.
 - 챗봇 답변을 기반으로 한 사용자의 판단이나 행동에 대해
   서비스 운영자는 책임을 지지 않습니다.

📌 최신 정보 반영 한계
 - 챗봇은 항상 최신 정보나 변경된 정책을 즉시 반영하지 못할 수 있습니다.
 - 공식적이거나 중요한 정보는 별도의 공지 또는 공식 안내를 통해 확인해 주시기 바랍니다.

📌 서비스 개선 목적의 활용
 - 챗봇 대화 내용은 서비스 품질 개선 및 안정적인 운영을 위해 활용될 수 있으며,
   관련 법령에 따라 안전하게 관리됩니다.

본 유의사항을 충분히 숙지하신 후 챗봇 서비스를 이용해 주시기 바랍니다.
보다 정확하고 신뢰할 수 있는 서비스를 제공하기 위해 지속적으로 노력하겠습니다.
...
안녕하세요.
챗봇 서비스 이용과 관련하여 아래와 같이 안내드립니다.

✅ 1. 무료 이용 정책
 - 챗봇은 최초 3회까지 무료로 이용 가능합니다.
 - 무료 이용 횟수 소진 후에는 결제 완료 시 추가 이용하실 수 있습니다.
 - 무료 이용 횟수는 **챗봇 대화 1회(새로운 대화 세션 기준)**로 차감됩니다.
   (대화 초기화 또는 새 세션 시작 시 1회로 간주될 수 있습니다.)

✅ 2. 결제 후 이용 안내
 - 결제 후에는 챗봇 서비스를 지속적으로 이용하실 수 있습니다.
 - 이용 가능 범위 및 조건은 결제 상품에 따라 달라질 수 있습니다.

✅ 3. 대화 리포트 기능
 - 챗봇 사용 시, 이전까지의 대화 내용을 리포트 형식으로 출력할 수 있습니다.
 - 대화 리포트는 사용자가 요청한 경우에 한해 제공됩니다.
 - 리포트에는 현재 세션 기준의 대화 내용만 포함되며,
   일부 민감한 정보는 제외될 수 있습니다.

✅ 4. 데이터 저장 및 관리
 - 챗봇 대화 내용은 리포트 제공 및 서비스 개선 목적으로 저장될 수 있습니다.
 - 모든 데이터는 관련 법령에 따라 안전하게 관리됩니다.

✅ 5. 챗봇 답변 유의사항
 - 챗봇이 제공하는 답변은 참고용 정보이며,
   법률·의료·재무 등 전문적인 자문을 대체하지 않습니다.

✅ 6. 서비스 정책 변경 안내
 - 챗봇 이용 정책 및 요금은 사전 공지 후 변경될 수 있습니다.
...
감사합니다.
        ...
        # 데이터 생성 & 저장
        for key, (user_id, user_email, user_password, user_nickname) in users.items():
            user = User(
                user_id=user_id,
                user_email=user_email,
                user_password=generate_password_hash(user_password),
                user_nickname=user_nickname,
                user_image=f"/static/profile_images/basic.png",
                user_birthdate=None,
                user_delete = 0,
                user_is_social = 0,
                user_money = 1000000,
        ...
        for key, (notice_id, notice_title, notice_write) in notices.items():
            notice = Notice(
                notice_id = notice_id,
                user_id = 1,
                ...
                notice_view_count = 0,
                notice_like = 0,
                notice_new = datetime.now(timezone.utc),
                notice_modify = None,
                notice_delete = 0,
            )
